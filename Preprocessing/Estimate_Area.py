...
def test():
    ...
    image1, mask = prp.hsv_otsu_threshold(inputImage)

    image2 = prp.and_mask(inputImage, mask)
    image3, polyRectImage, contourArea, minArea, badArea, minCircleArea = getROI(image2, mask)

    # Two roundness method formulas
